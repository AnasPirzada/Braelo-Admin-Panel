...
export const ArchivedChat = () => {
  return (
    <div>
      ...
      <Row>
        <ArchCard
          Profile='/public/Chat Images/Profile.png'
        ...
        />
        <ArchCard
          Profile='/public/Chat Images/JohnKnedy.png'
          userName='John Knedy'
          message='Is there a discount for large companies?'
        />
        <ArchCard
          Profile='/public/Chat Images/Anna.png'
          userName='Anna Mulana'
          message='I would like to make a complaint about..my account, could you help me?'
          chatimage='./Chat Images/gallery.svg'
        />
        <ArchCard
          Profile='/public/Chat Images/Jack.png'
          userName='Jack Markojek'
          message='I would like to make a complaint about..my account, could you help me?'
        />
        <ArchCard
          Profile='/public/Chat Images/Paul.png'
          userName='Paul Germano'
          message='I would like to make a complaint about..my account, could you help me?'
          chatimage='./Chat Images/gallery.svg'
        />
        <ArchCard
          Profile='/public/Chat Images/Germano.png'
          userName='Germano Bern'
          message='I would like to make a complaint about..my account, could you help me?'
        />
        <ArchCard
          Profile='/public/Chat Images/Rodrigo.png'
          userName='Rodrigo Sintra'
          message='I would like to make a complaint about..my account, could you help me?'
        />
        <ArchCard
          Profile='/public/Chat Images/Nabelle.png'
          userName='Nabelle Shop'
          message='I would like to make a complaint about..'
          chatimage='./Chat Images/gallery.svg'
        />
        <ArchCard
          Profile='/public/Chat Images/Paula.png'
          userName='Paula Muller'
          message='I would like to make a complaint about..'
        />
        <ArchCard
          Profile='/public/Chat Images/Gabriel.png'
          userName='Gabriel Passos'
          message='I would like to make a complaint about..'
        />
        <ArchCard
          Profile='/public/Chat Images/Renato.png'
